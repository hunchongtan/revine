-- =====================================================
-- ReVine Database Schema (Fixed - Skip Storage Policies)
-- =====================================================
...
DROP POLICY IF EXISTS "Users can delete their own remixes" ON remixes;
...
DROP TRIGGER IF EXISTS on_remix_updated ON remixes;
...
-- 6. INDEXES
-- =====================================================
CREATE INDEX IF NOT EXISTS idx_templates_year ON templates(year);
CREATE INDEX IF NOT EXISTS idx_templates_category ON templates(category);
CREATE INDEX IF NOT EXISTS idx_favourites_user_id ON favourites(user_id);
CREATE INDEX IF NOT EXISTS idx_favourites_template_id ON favourites(template_id);
CREATE INDEX IF NOT EXISTS idx_remixes_user_id ON remixes(user_id);
CREATE INDEX IF NOT EXISTS idx_remixes_template_id ON remixes(template_id);
CREATE INDEX IF NOT EXISTS idx_remixes_is_public ON remixes(is_public);
CREATE INDEX IF NOT EXISTS idx_remixes_created_at ON remixes(created_at DESC);

-- =====================================================
-- 7. STORAGE BUCKETS (SKIPPED - Already exists)
-- =====================================================
-- Storage policies already exist from previous run
